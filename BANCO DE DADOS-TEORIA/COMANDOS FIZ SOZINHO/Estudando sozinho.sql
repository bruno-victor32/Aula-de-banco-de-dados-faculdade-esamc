...
nome varchar (30) not null unique,/*Unique e o seguinte eu ñ estou dizendo que o nome e uma chave primaria ele nãao vai identificar os registros,mas ele não vai deixar 
colocar 2 cursos com o mesmo nome*/
